...
const tutorialSteps = [
    ...
    label: (
      <div>
        ...
        <p>
          <b>
            <font color="blue">
              Note that the guidelines for correct decompositions have been changed!
              <br />
              We are targeting decomposing trivia questions.
              <br />
              These decompositions are granular in nature. A list of
              specific examples has been added.
              <br />
            </font>
            <font color="red">
              Please review the new trivia decomposition examples next.
            </font>
          </b>
        </p>
        <p>
        ...
        <font color="red">
          <p>
            <b>
              Click 'Next' to review the new trivia question decomposition
              examples.
            </b>
          </p>
        </font>
  ...
  {
    title: "*NEW* Trivia Decompositions",
    label: (
      <div>
        <p>
          This task is identical to our original question decomposition task.
          <br />
          You are presented with decomposing a trivia question. For example:
          <ul>
            <li>
              "What language do they speak in Spain besides spanish?"
            </li>
          </ul>
          Its correct decomposition should be:
          <ol>
            <li>Return Spain</li>
            <li>Return languages of #1</li>
            <li>Return Spanish language</li>
            <li>Return #2 besides #3</li>
          </ol>
          The final question step should return the answer to the original question.
          <br />
          Steps #1 and #3 both return entities (Spain and the Spanish language),
          while step #2 returns a propety of Spain (its languages).
        </p>
        <p>
          Listed below are several examples of questions and their correct
          decompositions.
          <br />
          <font color="red">
            <b>
        ...
        <p>
          ...
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(A)  What year did Canadians join NATO?"
                }
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#1</ListItemIcon>
              <ListItemText disableTypography primary={"Return the Canadians join NATO"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return year of #1"}
              />
            </ListItem>
          </List>
          <hr />
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(B)  What is the largest mountain range in Africa?"
                }
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#1</ListItemIcon>
              <ListItemText disableTypography primary={"Return Africa"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return mountain ranges of #1"}
              />
            </ListItem>
            <ListItem button>
            ...
            <ListItem button>
              ...
              <ListItemText
                disableTypography
                primary={"Return #2 where #3 is largest"}
              />
            </ListItem>
          </List>
          <hr />
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(C)  What years did Cale Yarborough win his cup championships?"
                }
              />
            </ListItem>
            <ListItem button>
              ...
              <ListItemText
                disableTypography
                primary={"Return Cale Yarborough"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText disableTypography primary={"Return cup championship wins of #1"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#3</ListItemIcon>
              <ListItemText disableTypography primary={"Return years of #2"} />
            </ListItem>
          </List>
          <hr />
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(D)  Who was king Henry the VIII fourth wife?"
                }
              />
            </ListItem>
            <ListItem button>
              ...
              <ListItemText
                disableTypography
                primary={"Return king Henry the VIII"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText disableTypography primary={"Return wives of #1"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#3</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return fourth of #2"}
              />
            </ListItem>
          </List>
          <hr />
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(E)  the 2nd longest river in Africa?"
                }
              />
            </ListItem>
            <ListItem button>
            ...
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText disableTypography primary={"Return rivers of #1"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#3</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return longest of #2"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#4</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return #2 besides #3"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#5</ListItemIcon>
              <ListItemText disableTypography primary={"Return longest of #4"} />
            </ListItem>
          </List>
          <hr />
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(F)  Who did Lucille Ball marry after Desi Arnaz?"
                }
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#1</ListItemIcon>
              <ListItemText disableTypography primary={"Return Lucille Ball"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText disableTypography primary={"Return Desi Arnaz"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#3</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return who did #1 marry"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#4</ListItemIcon>
          ...
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(G)  What is the name of the deepest lake in the United Stated?"
                }
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#1</ListItemIcon>
              <ListItemText disableTypography primary={"Return United States"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return lakes of #1"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#3</ListItemIcon>
            ...
            <ListItem button>
              ...
              <ListItemText
                disableTypography
                primary={"Return #2 where #3 is highest"}
              />
            </ListItem>
          </List>
          <hr />
          <List component="nav">
            <ListItem button>
              <ListItemText
                primary={
                  "(H)  What European country touches Portugal and France?"
                }
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#1</ListItemIcon>
              <ListItemText disableTypography primary={"Return European country"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#2</ListItemIcon>
              <ListItemText disableTypography primary={"Return Portugal"} />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#3</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return France"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#4</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return #1 that touches #2"}
              />
            </ListItem>
            <ListItem button>
              <ListItemIcon>#5</ListItemIcon>
              <ListItemText
                disableTypography
                primary={"Return #1 that touches #3"}
              />
            </ListItem>
            <ListItem button>
              ...
              <ListItemText
                disableTypography
                primary={"Return #1 in both #4 and #5"}
              />
            </ListItem>
          </List>
        </p>
