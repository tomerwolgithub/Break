    ...
    label: (
      <div>
        ...
        <p>
          <b>
            <font color="blue">
              The guidelines for correct decompositions have been changed!
              <br />
              We have returned to our original more granular decompostion
              templates.
              <br />
            </font>
            <font color="red">
              Please make sure to review the updated decomposition instructions
              next.
            </font>
          </b>
        </p>
